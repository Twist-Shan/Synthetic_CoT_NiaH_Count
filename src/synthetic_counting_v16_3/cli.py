...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run isolated synthetic counting v16_3")
    ...
    order.add_argument(
        ...
        action="store_true",
        default=None,
        help="shuffle the three query members per example (default)",
    )
    order.add_argument(
        "--canonical-needle-set-order",
        dest="shuffle_needle_set_order",
        action="store_false",
        help="render the three query members in canonical code-point order",
    )
    parser.add_argument("--out-root", default="runs/synthetic_counting_v16_3")
...
def main(argv: list[str] | None = None) -> None:
    ...
    from .pipeline import run_v16_3_pipeline
