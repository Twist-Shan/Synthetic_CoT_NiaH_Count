...
def _fixed_total_subset(
    examples: list[V16_2Example], total_count: int, limit: int
) -> list[V16_2Example]:
...
def _state_sampling_suites(
    examples: list[V16_2Example], per_label: int, count_max: int, mode: str
) -> tuple[list[V16_2Example], list[V16_2Example]]:
...
def _analyze_checkpoint(
    ...
    *,
    ...
    with timed_event(
        ...
        attention_examples: list[V16_2Example] = []
        split_by_prompt: dict[str, str] = {}
        ...
        if options.run_states:
            ...
            if not reuse_state_family:
                ...
                with timed_event(
                    ...
                    train_states.update(collect_v16_2_states(
                    ...
                    if not any(key[0] == "final_answer" for key in heldout_states):
                        heldout_states.update(collect_v16_2_states(
...
def run_v16_2_checkpoint_dynamics(
    ...
    *,
    ...
    options_fingerprint = _json_fingerprint({
        "version": "v16_2_revision_6_deconfounded_states_ar_reporting", "config": cfg.to_dict(),
