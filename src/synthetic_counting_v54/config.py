...
def preset_config(preset: str = "debug", **overrides: Any) -> V54Config:
    """Build v54: v51 with a mild Thinking-only self-generated roll-in."""
...
__all__ = ["V54Config", "preset_config"]
