...
def preset_config(preset: str = "debug", **overrides: Any) -> V46Config:
    """Build v46: v35 capacity with full support and permuted task windows."""
...
__all__ = ["V46Config", "preset_config"]
