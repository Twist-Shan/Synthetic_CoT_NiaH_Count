...
def preset_config(preset: str = "debug", **overrides: Any) -> V33Config:
    """Build the independent scheduled-roll-in efficiency experiment."""
...
__all__ = ["V33Config", "preset_config"]
