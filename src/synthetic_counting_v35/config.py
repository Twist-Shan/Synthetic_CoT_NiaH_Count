...
def preset_config(preset: str = "debug", **overrides: Any) -> V35Config:
    """Build the independent equal-component separator-trace experiment."""
...
__all__ = ["V35Config", "preset_config"]
