...
def preset_config(preset: str = "debug", **overrides: Any) -> V47Config:
    """Build v47: v46 with an equal 10,000-step horizon for both modes."""
...
__all__ = ["V47Config", "preset_config"]
