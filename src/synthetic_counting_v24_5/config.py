...
V245Config = V20Config


def preset_config(preset: str = "debug", **overrides: Any) -> V245Config:
    """Build the v24.4-matched 20-set supervision-density control."""
...
__all__ = ["V245Config", "preset_config"]
