...
def preset_config(preset: str = "debug", **overrides: Any) -> V41Config:
    """Build the independent v40 count-1..5 width/head-capacity control."""
...
__all__ = ["V41Config", "preset_config"]
