...
def preset_config(preset: str = "debug", **overrides: Any) -> V49Config:
    """Build v49: v47 with grammar-balanced separator loss partitioning."""
...
__all__ = ["V49Config", "preset_config"]
