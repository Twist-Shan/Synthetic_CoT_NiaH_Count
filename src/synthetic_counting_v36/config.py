...
def preset_config(preset: str = "debug", **overrides: Any) -> V36Config:
    """Build the independent equal-component 10k-decay-horizon screen."""
...
__all__ = ["V36Config", "preset_config"]
