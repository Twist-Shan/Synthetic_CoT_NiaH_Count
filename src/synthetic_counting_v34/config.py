...
def preset_config(preset: str = "debug", **overrides: Any) -> V34Config:
    """Build the independent trace-region-weight-8 efficiency experiment."""
...
__all__ = ["V34Config", "preset_config"]
