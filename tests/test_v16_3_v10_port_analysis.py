...
from synthetic_counting_v16_3.interactive_geometry import mean_first_pca
from synthetic_counting_v16_3.needle_pool import build_needle_pool
from synthetic_counting_v16_3.report_readability import FIGURE_SPECS, polish_report_html
from synthetic_counting_v16_3.training import paired_v16_3_model
from synthetic_counting_v16_3.v10_port_analysis import (
    _attention_vectors,
...
def prepared():
    ...
    examples = balanced_v16_3_examples(
        cfg, vocab, text, split, pool, 1, 8162, region_name="validation"
    )
    model = paired_v16_3_model(cfg, vocab, "rope").eval()
...
def test_same_attention_slice_patch_and_same_residual_patch_are_noops(prepared):
    ...
    item = render_v16_3(example, vocab, "thinking")
...
def test_v10_crosswalk_covers_all_mechanism_sections():
    ...
    assert frame["v16_3_implementation"].str.len().min() > 10
