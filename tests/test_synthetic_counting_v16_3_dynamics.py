...
from synthetic_counting_v16_3.analysis import (
    _attention_categories,
    fit_ridge,
    ridge_raw_direction,
)
from synthetic_counting_v16_3.checkpoint_dynamics import (
    DynamicsOptions,
    _artifact_manifest,
    _atomic_json,
    _geometry_metrics,
...
from synthetic_counting_v16_3.timing import record_cached_event, timed_event
...
def test_shortened_trace_removes_only_final_pair(prepared):
    ...
    example = next(
        item
        for item in balanced_v16_3_examples(
...
def test_attention_category_metrics_match_hand_calculation(prepared):
    ...
    rendered = render_v16_3(example, vocab, "nonthinking")
