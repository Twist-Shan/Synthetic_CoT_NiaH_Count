#!/usr/bin/env python3
"""Create publication-style figures for the v16.2 v10-port analysis."""
...
def representation_2d(run_dir: Path) -> Path:
    ...
    fig.suptitle("v16.2 mean-first residual manifolds: centroid path plus held-out sample cloud", y=1.01, fontsize=13)
    fig.tight_layout()
